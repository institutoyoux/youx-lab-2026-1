...
import com.curso.libraryapi.validator.AutorValidator;
...
public class AutorService {
    ...
    public void atualizar(Autor autor){
        if (autor.getId() == null){
            throw new IllegalArgumentException("Para atualizar, é necessario que o autor já esteja salvo no sistema");
        }
        validator.validar(autor);
