...
export default function RadarGrafico({data, formatter}) {
    ...
    return (
        <section>
            ...
            <RadarChart style={{ width: '100%', height: '100%', maxWidth: '500px', maxHeight: '80vh', aspectRatio: 1 }}
                ...
                <PolarRadiusAxis />
                <Radar name='lucro' dataKey="lucro" fill='#0000ff' />

                <Tooltip labelFormatter={teste => "Lucro liquido"} formatter={valor => formatter.format(valor)}/>
            </RadarChart>
        </section>
    )
}